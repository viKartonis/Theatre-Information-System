...
public class MenuProductorDesigner implements ActionListener, ItemListener {
    private JMenuBar menuBar = new JMenuBar();
    private JMenu role = new JMenu("Художник-постановщик");
    private String producerName = new String();
    private JLabel label;

    public MenuProductorDesigner(List<String> names, JLabel label) {
