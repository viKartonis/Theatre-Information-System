...
public class MenuConductors implements ActionListener, ItemListener {
    private JMenuBar menuBar = new JMenuBar();
    private JMenu role = new JMenu("Дирижёр");
    private String producerName = new String();
    private JLabel label;

    public MenuConductors(List<String> names, JLabel label) {
